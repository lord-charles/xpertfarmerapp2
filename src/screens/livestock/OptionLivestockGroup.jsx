...
export default function OptionLivestockGroupScreen({ navigation }) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <SecondaryHeader title="Livestock Group" />
            <View style={styles.optionsContainer}>

                <FormControl className='mb-2'>
                    <FormControl.Label _text={{ fontSize: 'lg', fontWeight: 'medium', color: 'coolGray.800' }}>Group Name</FormControl.Label>
                    <Input
                ...
                <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate('AddLivestockGroupScreen')}
                >
                    <RadioButton
                        value="oneByOne"
                        ...
                        color="#4CAF50"
                    />
                    <Text style={styles.optionText}>Key in livestock group one by one</Text>
                </TouchableOpacity>
