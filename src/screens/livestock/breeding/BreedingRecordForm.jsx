  ...
  return (
    <View className="flex-1 bg-white">
      ...
      <ScrollView contentContainerStyle={styles.container}>
        <View>
          <Text className="text-[18px] font-semibold text-black text-center pb-2">
            Breeding Purpose & Strategy
          </Text>
        ...
        <View style={styles.section}>
          ...
          <Radio.Group
            ...
            <Radio value="Natural Birth" my={1}>
              Natural Birth
            </Radio>
            <Radio value="Assisted" my={1}>
              Assisted
            </Radio>
            <Radio value="Cesarean" my={1}>
              Cesarean
            </Radio>
          </Radio.Group>
        </View>
